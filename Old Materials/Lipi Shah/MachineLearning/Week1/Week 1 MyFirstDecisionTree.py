...
import os
#os.environ["PATH"] += os.pathsep + 'C:/Users/Lipi/Downloads/graphviz-2.38/elease\bin'
import graphviz
...
trainData = pandas.read_csv('C:\\Users\\Lipi\\Downloads\\MachineLearning\Week1\hmeq.csv',
                             delimiter=',', usecols = ['BAD', 'DELINQ'])

#C:\\Users\\Lipi\\Downloads\\MachineLearning\Week1\hmeq.csv
