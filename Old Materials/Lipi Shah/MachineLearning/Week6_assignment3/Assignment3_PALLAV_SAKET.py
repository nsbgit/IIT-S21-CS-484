...
claim_history = pandas.read_csv('C:\\Users\\Lipi\\Downloads\\MachineLearning\\Week6_assignment3\\claim_history.csv',delimiter=',')
X = claim_history.iloc[:, [11,12,17]].values
Y = claim_history.iloc[:, 14].values

X_train, X_test, Y_train, Y_test = train_test_split(X, Y, test_size = 0.25, random_state = 60616, stratify = claim_history['CAR_USE'])
