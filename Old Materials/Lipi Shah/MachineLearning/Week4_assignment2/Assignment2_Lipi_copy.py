# -*- coding: utf-8 -*-
"""
Created on Sun Feb 16 16:34:54 2020
...
c1 = cars.iloc[[75]].to_numpy().ravel()
...
for j in range(7):
    print('Eigenvalue: ', j)
    print('              Mean = ', np.mean(evecs[:,j]))
    print('Standard Deviation = ', np.std(evecs[:,j]))
