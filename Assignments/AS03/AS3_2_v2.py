...
claimData['EDUCATION'] = claimData['EDUCATION'].map({'Below High School': 0, 'High School': 1, 'Bachelors': 2, 'Masters': 3, 'Doctors': 4})

splitEducation = findMinEntropyForOrdinal(claimData[['EDUCATION', 'CAR_USE']], [0, 1, 2, 3, 4])
splitCarType = findMinEntropyForNominal(claimData[['CAR_TYPE', 'CAR_USE']], ['Minivan', 'Panel Truck', 'Pickup', 'SUV', 'Sports Car','Van'])
splitOccupation = findMinEntropyForNominal(claimData[['OCCUPATION', 'CAR_USE']], ['Blue Collar', 'Clerical', 'Doctor', 'Home Maker', 'Lawyer', 'Manager', 'Professional', 'Student', 'Unknown'])
...
splitLeftCar = findMinEntropyForNominal(splitLeft[['CAR_TYPE', 'CAR_USE']],['Minivan', 'Panel Truck', 'Pickup', 'SUV','Sports Car', 'Van'])
splitLeftOccupation = findMinEntropyForNominal(splitLeft[['OCCUPATION', 'CAR_USE']],['Blue Collar', 'Clerical', 'Doctor', 'Home Maker', 'Lawyer', 'Manager', 'Professional', 'Student', 'Unknown'])
...
splitRightEducation = findMinEntropyForOrdinal(splitRight[['EDUCATION', 'CAR_USE']],
                                               [0, 1, 2, 3, 4])
splitRightCar = findMinEntropyForNominal(splitRight[['CAR_TYPE', 'CAR_USE']],['Minivan', 'Panel Truck', 'Pickup', 'SUV','Sports Car', 'Van'])
splitRightOccupation = findMinEntropyForNominal(splitRight[['OCCUPATION', 'CAR_USE']],['Blue Collar', 'Clerical', 'Doctor', 'Home Maker','Lawyer', 'Manager', 'Professional', 'Student', 'Unknown'])
